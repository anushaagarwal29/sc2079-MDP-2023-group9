...
public class Simulator extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Stop[] stops = new Stop[]{new Stop(0, Color.SILVER), new Stop(1, Color.ROYALBLUE)};
        ...
        directionBox.setMinSize(61, 0);
        directionBox.getSelectionModel().selectFirst();

        // buttons
        Button obstacleButton = new Button("Add");
        ...
        obstacleButton.setStyle("-fx-background-color: green;-fx-text-fill: white;");
        ...
        simulateButton.setMinSize(100, 0);
        simulateButton.setOnAction(runSimulation);
        simulateButton.setStyle("-fx-background-color: #D0312D;-fx-text-fill: white;");

        Pane spring = new Pane();
        Pane spring2 = new Pane();
        spring.minHeightProperty().bind(simulateButton.heightProperty());
        spring2.minHeightProperty().bind(simulateButton.heightProperty());
        GridPane buttonBar = new GridPane();
        buttonBar.setAlignment(Pos.CENTER);
        buttonBar.add(spring, 0, 0);
        buttonBar.add(xLabel, 0, 1);
        buttonBar.add(yLabel, 1, 1);
        buttonBar.add(dirLabel, 2, 1);
        buttonBar.add(xField, 0, 2);
        buttonBar.add(yField, 1, 2);
        buttonBar.add(directionBox, 2, 2);
        buttonBar.add(obstacleButton, 3, 2);
        buttonBar.add(spring2, 0, 3);
        buttonBar.add(simulateButton, 1, 5);
        ...
        primaryStage.setScene(new Scene(vbox, arenaSize, arenaSize + 180));
